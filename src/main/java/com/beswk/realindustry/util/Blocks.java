...
import com.beswk.realindustry.Blocks.InternalCombustionEngine;
...
public class Blocks {
    ...
    public static final Block INTERNAL_COMBUSTION_ENGINE = Registry.registerBlock(new InternalCombustionEngine(),"internal_combustion_engine",RealIndustry.MATERIAL,RealIndustry.bus);
}
