...
public class SeniorGeneratorScreen extends AbstractContainerScreen<SeniorGeneratorMenu> {
    private final static HashMap<String, Object> guistate = SeniorGeneratorMenu.guistate;
    ...
    public SeniorGeneratorScreen(SeniorGeneratorMenu container, Inventory inventory, Component text) {
    ...
    private static final ResourceLocation texture = new ResourceLocation("realindustry:textures/gui/container/senior_generator.png");
    ...
    protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
        ...
        this.blit(ms, this.leftPos + 76, this.topPos + 54, 0, 0, 22, 15, 22, 15);

        RenderSystem.setShaderTexture(0, new ResourceLocation("realindustry:textures/gui/container/arrow_back.png"));
        this.blit(ms, this.leftPos + 76, this.topPos + 19, 0, 0, 22, 15, 22, 15);
        ...
        if (entity instanceof IGeneratorBlockEntity iGeneratorBlockEntity) {
            ...
            blit(ms, this.leftPos + 44, this.topPos + 38, 0, 0, 13, 13-(int) (process * 0.013), 13, 13);
