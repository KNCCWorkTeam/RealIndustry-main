...
public class BlockEntities {
    ...
    public static final BlockEntityType<?> COPPER_ACCUMULATOR_ENTITY = Registry.registerBlockEntity("copper_accumulator_entity", CopperAccumulatorBlockEntity::new,Blocks.COPPER_ACCUMULATOR);
}
