package com.beswk.realindustry.Items;
...
public class EnderiteScrap extends MinecraftItem {
    public EnderiteScrap() {
        super(RealIndustry.MATERIAL);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41190_, Player p_41191_, InteractionHand p_41192_) {
        ...
        p_41191_.getCooldowns().addCooldown(this, 5);
